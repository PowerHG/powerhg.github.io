...
Chart.ready(() => {
	...
	listHtml +=
		`<a data-id='node.procId' href='javascript:AddStart()' style='color: #000; text-decoration: none;'><li><span class='node-name'>Input</span></li></a>`;
	listHtml +=
		`<a data-id='node.procId' href='javascript:AddEnd()' style='color: #000; text-decoration: none;'><li><span class='node-name'>Output</span></li></a>`;
	...
	$('.right').append($('<div id="DEBUG_DIV"></div>'))
